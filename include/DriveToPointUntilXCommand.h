...
private:
    ...
    bool timedOut;
    bool startedLeftOfOrOnExitLine;
    ...
    void startCurrentUnstuckMovement() {
        setCommandStatus("Drive Until X Unstuck");
...
public:
    DriveToPointUntilXCommand(
        ...
        : drivetrain(drivetrain),
          ...
          pointingTimerSet(false),
          timedOut(false),
          startedLeftOfOrOnExitLine(false),
          endTime(0),
    ...
    void initialize() override {
        ...
        startedLeftOfOrOnExitLine = currentX <= target.exit_x;
    }
