...
//     var.x_is_stable = abs(var.lastBlockXDistance) <= conf.maxDifferenceDistance;
//     var.y_is_stable = abs(var.lastBlockYDistance) <= conf.maxDifferenceDistance;
...
//     //sees a block with tracking already started, jump too far
//     var.xJump = block_x_pos - var.lastBlockXPos;
//     var.yJump = block_y_pos - var.lastBlockYPos;

//     var.xJumpValid = abs(var.xJump) <= conf.maxTrackingXJump;
//     var.yJumpValid = abs(var.yJump) <= conf.maxTrackingYJump;
...
//     //sees block and accepts as same block
//     var.lastBlockXPos = block_x_pos;
//     var.lastBlockYPos = block_y_pos;
...
//     Brain.Screen.print("Block X: %d    ", block_x_pos);

//     Brain.Screen.setCursor(2, 1);
//     Brain.Screen.print("Block Y: %d    ", block_y_pos);
